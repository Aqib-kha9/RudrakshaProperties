      ...
      <div className="max-w-[1400px] mx-auto px-3 md:px-3">
        ...
        <div className="relative rounded-[2rem] md:rounded-[2.5rem] overflow-hidden min-h-[380px] md:min-h-[460px] flex items-center justify-center text-center group">
          ...
          <img
            ...
            alt="Book a site visit with Rudraksha Properties"
          />
          ...
          <div className="relative z-10 px-6 md:px-12 max-w-2xl w-full">
            <h3 className="text-[36px] md:text-[52px] lg:text-[64px] font-bold text-white leading-tight tracking-tight mb-4">
              Your Dream Home <br /> Begins Here.
            </h3>
            <p className="text-[14px] md:text-[16px] text-white/70 font-medium leading-relaxed mb-10 max-w-md mx-auto">
              Share your number and our property experts will call you back to schedule a free site visit.
            </p>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-3 max-w-xl mx-auto">
              ...
              {/* WhatsApp Button */}
              <a
                href="https://wa.me/919009250061?text=Hi%20Rudraksha%20Properties!%20I'd%20like%20to%20enquire%20about%20a%20property%20and%20book%20a%20site%20visit."
                target="_blank"
