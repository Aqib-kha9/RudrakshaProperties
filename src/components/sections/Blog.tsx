...
export function Blog() {
  ...
  useEffect(() => {
    // API fetch disabled to prevent loading travel blogs from DB
  }, []);
      ...
      <div className="max-w-[1400px] mx-auto px-3 md:px-3">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-4 items-end mb-12 md:mb-16">
          <div className="md:col-span-7">
            ...
            >
              Market <br />
              <span className="text-black/20 italic">Insights.</span>
            </motion.h2>
          </div>
          <div className="md:col-span-5 flex flex-col items-start md:items-end md:text-right">
             <div className="flex items-center gap-2 mb-4">
                ...
                <span className="text-[11px] font-black uppercase tracking-[0.3em] text-black italic">Real Estate Updates</span>
             </div>
             <p className="text-[14px] text-black/50 font-medium leading-relaxed max-w-[320px] mb-8">
                Stay updated on property trends, investment tips, and real estate news from Indore & MP.
             </p>
             <Link
               href="/journal"
