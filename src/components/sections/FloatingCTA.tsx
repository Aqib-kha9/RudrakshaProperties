...
import { Phone, MessageCircle, ArrowRight, Home } from 'lucide-react';
import { useState, useEffect } from 'react';

const WHATSAPP_NUMBER = "919009250061";
const PHONE_NUMBER = "+919009250061";
const WHATSAPP_MSG = "Hi Rudraksha Properties! I'd like to enquire about a property.";
